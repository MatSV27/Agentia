        ...
        <div className="container">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a href="#features" className="text-gray-600 hover:text-green-700 transition-colors">Funcionalidades</a>
              <a href="#demo" className="text-gray-600 hover:text-green-700 transition-colors">Demo</a>
              <a href="#testimonials" className="text-gray-600 hover:text-green-700 transition-colors">Testimonios</a>
              <a href="#pricing" className="text-gray-600 hover:text-green-700 transition-colors">Precios</a>
            </nav>
