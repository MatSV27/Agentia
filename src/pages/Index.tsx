        ...
        <div className="container">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button className="bg-brand-purple hover:bg-brand-purple/90">Registrarse</Button>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Comienza a optimizar tu productividad hoy
              </h2>
              <p className="text-lg mb-8 text-white/80">
                Únete a miles de personas que están transformando sus hábitos 
                y alcanzando sus metas con nuestra plataforma de productividad.
              </p>
      ...
      <footer className="py-12 bg-gray-50">
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-bold mb-4">PlannerAI</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Sobre nosotros</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Blog</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Carreras</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">Producto</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Funcionalidades</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Precios</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Integraciones</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">Recursos</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Guías</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Documentación</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Webinars</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">Legal</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Privacidad</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Términos</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-brand-purple">Cookies</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground">
              &copy; {new Date().getFullYear()} PlannerAI. Todos los derechos reservados.
            </p>
